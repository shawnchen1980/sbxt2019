        ...
        <div class="col-md-12">
            <div class="form-horizontal">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dt>外部登录名:<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Button" />
                    </dt>
                    <dd><%: LoginsCount %>
                    ...
                    --%>
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/NewFolder1/WebForm1.aspx">HyperLink</asp:HyperLink>
